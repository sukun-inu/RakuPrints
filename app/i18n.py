...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "ja": {
        ...
        "usage_tab": "使い方",
        "usage_body": "## 使い方\n1. アプリを起動\n2. ファイルやフォルダーを追加（ドラッグ&ドロップ可）\n3. プリンターや両面、用紙サイズを設定\n4. **印刷開始**をクリック\n\n## 便利機能\n- 右クリックで「選択行のみ印刷」「プリンター個別指定」「PDF印刷オプション」「Excelシート選択」「上へ/下へ移動」\n- ドラッグ&ドロップ、または **Alt+↑/↓** で印刷順を入れ替え\n- 失敗だけ再印刷\n- PDF余白テスト印刷（プリンターの印字可能領域を確認）\n- PDF自動回転/センタリング/縮小率の調整",
    },
    "en": {
        ...
        "usage_tab": "How to",
        "usage_body": "## How to\n1. Launch the app\n2. Add files/folders (drag & drop supported)\n3. Set printer, duplex, and paper size\n4. Click **Start Printing**\n\n## Tips\n- Right-click for \"Print selected\", \"Set printer\", \"PDF options\", \"Excel sheets\", \"Move up/down\"\n- Reorder with drag & drop or **Alt+Up/Down**\n- Reprint failed jobs only\n- PDF margin test print (check printable area)\n- Adjust PDF auto-rotate/centering/scale",
    },
    "ko": {
        "app_title": "라쿠 인쇄",
        "menu_file": "파일",
        ...
        "usage_tab": "사용 방법",
        "usage_body": "## 사용 방법\n1. 앱 실행\n2. 파일/폴더 추가(드래그&드롭 가능)\n3. 프린터, 양면, 용지 크기 설정\n4. **인쇄 시작** 클릭\n\n## 팁\n- 우클릭 메뉴: 선택 항목만 인쇄, 프린터 지정, PDF 옵션, Excel 시트 선택, 위/아래 이동\n- 드래그&드롭 또는 **Alt+위/아래** 로 순서 변경\n- 실패한 작업만 재인쇄\n- PDF 여백 테스트 인쇄(인쇄 가능 영역 확인)\n- PDF 자동 회전/가운데 정렬/축소율 조정",
    },
    "zh": {
        "app_title": "乐印",
        "menu_file": "文件",
        ...
        "usage_tab": "使用方法",
        "usage_body": "## 使用方法\n1. 启动应用\n2. 添加文件/文件夹（支持拖拽）\n3. 设置打印机、双面、纸张尺寸\n4. 点击 **开始打印**\n\n## 小贴士\n- 右键菜单：仅打印所选、指定打印机、PDF 选项、选择 Excel 工作表、上移/下移\n- 通过拖拽或 **Alt+↑/↓** 调整顺序\n- 仅重打失败任务\n- PDF 边距测试打印（查看可打印区域）\n- 调整 PDF 自动旋转/居中/缩放比例",
    },
}
